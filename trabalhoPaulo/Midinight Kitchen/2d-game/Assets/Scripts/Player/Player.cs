...
public class Player : MonoBehaviour
{
    ...
    {
        get { return amountHealth; }
        set { amountHealth = value; }
    }
    ...
    // Start is called once before the first execution of Update after the MonoBehaviour is created, palola esteve aqui
    void Start()
    {
    ...
    // belly e daniel estivberam aqui
    void Update()
    {
        OnJump();
        OnAttack();
    ...
    void OnMove()
    {
        ...
        //movendo o objeto na direção do input do jogador, palola esteve aqui
